      ...
      <section style={{ backgroundColor: "white" }}>
        <div className="mobile-split" style={{
          ...
          <div className="mobile-split-image" style={{ position: "relative", minHeight: "400px" }}>
            <Image src="/images/porto-peschereccio.jpg" alt="Il porto peschereccio di Licata" fill style={{ objectFit: "cover" }}  quality={95}  sizes="100vw" />
          </div>
      ...
      <section style={{ backgroundColor: "white" }}>
        <div className="mobile-split" style={{
          ...
          <div className="mobile-split-image" style={{ position: "relative", minHeight: "400px", order: 2 }}>
            <Image src="/images/vineyard-rows.jpg" alt="Vigneti e campagna siciliana" fill style={{ objectFit: "cover" }}  quality={95}  sizes="100vw" />
          </div>
        </div>
      </section>
          ...
          <div style={{
            ...
            <div style={{ backgroundColor: "white", overflow: "hidden" }}>
              <div style={{ position: "relative", width: "100%", aspectRatio: "16/9" }}>
                <Image src="/images/centro-storico.jpg" alt="Il Centro Storico di Licata" fill style={{ objectFit: "cover" }}  quality={95}  sizes="100vw" />
              </div>
            ...
            <div style={{ backgroundColor: "white", overflow: "hidden" }}>
              <div style={{ position: "relative", width: "100%", aspectRatio: "16/9" }}>
                <Image src="/images/castel-sant-angelo.jpg" alt="Castel Sant'Angelo" fill style={{ objectFit: "cover", filter: "brightness(1.25) contrast(1.05)" }}  quality={95}  sizes="100vw" />
              </div>
              <div style={{ padding: "40px" }}>
                <h4 style={{
                  fontFamily: "Cormorant Garamond, serif",
            ...
            <div style={{ backgroundColor: "white", overflow: "hidden" }}>
              <div style={{ position: "relative", width: "100%", aspectRatio: "16/9" }}>
                <Image src="/images/spiagge.jpg" alt="Le Spiagge di Licata" fill style={{ objectFit: "cover" }}  quality={95}  sizes="100vw" />
              </div>
              <div style={{ padding: "40px" }}>
                <h4 style={{
                  fontFamily: "Cormorant Garamond, serif",
